...
// The job must exist and be open to new tasks - this enforces the
// pick-from-list-only location rule server side.
list($taskId, $message) = createTask((int)$input['job_id'], $input['tech_name'], $startTime);
