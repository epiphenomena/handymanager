...
$jobA = createJob('Smith - 412 Oak Ave', 'Smith', '555-0101', 'Leaky kitchen faucet, also asked about regrouting the bathroom tile.');

// --- In-progress job with tasks ---
$jobB = createJob('Hendersons - 88 Lakeview Dr', 'Hendersons', '555-0102', 'Deck boards rotting near the stairs. Wants an estimate for full replacement.');
...
$jobD = createJob('Riverside Cafe - 301 Main St', 'Riverside Cafe', '555-0104', 'Replace back door and frame.');
...
$jobE = createJob('Garcia - 19 Elm St', 'Garcia', '555-0105', 'Fence gate sagging.');
...
$jobF = createJob('Smith - 412 Oak Ave', 'Smith', '555-0101', 'PREVIOUS visit: garbage disposal replacement.');
